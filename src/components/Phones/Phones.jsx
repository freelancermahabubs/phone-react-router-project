...
const Phones = () => {
  ...
  return (
    ...
    <div className="col-span-1 my-4 cart rounded bg-orange-300">
      <Cart 
      handleClearCart={handleClearCart}
       cart={cart}>
           <Link to = "/orders">
   <button className='flex justify-between font-semibold text-white w-[75%] mx-auto my-5 bg-yellow-800 rounded-md text-xl p-2 items-center'>Review Order
